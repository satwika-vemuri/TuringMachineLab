...
public class TurningMachineRunner {
    ...
    public static void main(String[] args) {
        ...
        Transition[] leftHashTransitions = {(new Transition("1", "1", "leftHash", 0)), (new Transition("0", "1", "L1", 0))};
        ...
        Transition[] L4Transitions = {(new Transition("0", "1", "toLeftHash", 1))};
        ...
        State R4 = new State ("R4", R4Transitions, false, 14); 
